...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      const response = await api.get<Repository>(`transactions`);
      ...
      repository.transactions.map(transaction => {
      ...
      setTransactions(repository.transactions);
      setBalance(repository.balance);
    }
